...
const ResumeBuilder = () => {
    ...
    const sections = [
		...
		{ id: "projects",name:"Education",icon:GraduationCap},
...
/>
						...
						<button className='bg-gradient-to-br from-blue-100 to-blue-200 
						ring-blue-300 text-blue-600 ring hover:ring-blue-400 transition-all rounded-md
