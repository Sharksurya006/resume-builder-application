import { BriefcaseBusiness, Globe, GlobeIcon, Linkedin, Mail, MapPin, Phone, User } from 'lucide-react'
		...
		<div className="flex items-center gap-2">
          <label>
			...
			className="w-16 h-16 rounded-full object-cover mt-5 ring ring-slate-300 hover:opacity-80"/>) :(
				<div className="inline-flex items-center gap-2 mt-5 text-slate-6000 hover:text-slate-700 cursor-pointer">
			...
			fields.map((field)=>{
				...
				return (
					<div key={field.key} className="space-y-1 mt-5">
                         <label className="flex flex-items gap-2 text-sm font-medium text-gray-600">
