  ...
  return (
	<div className="space-y-4">
	   ...
	   <div className='flex gap-2'>
		 <input type='text' placeholder="Enter a skill (e.g Python)" className="flex-1 px-3 py-2 text-sm" 
	   ...
	   {data.length > 0 ? (
		<div className="flex flex-wrap gap-2">
             {data.map((skill,index)=>(
               <span key={index} className='flex items-center gap-1 px-3 py-1 bg-blue-100 text-black
	   ...
	   <div className='bg-blue-50 p-3 rounded-lg'>
		  ...
		  > <strong>Tip:</strong>Add 8-12 relevant skills. Include both technical skills (programming languages,tools) and soft skills</p>
	   </div>
	</div>
  )
}
