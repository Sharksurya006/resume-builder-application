...
const Testimonial = () => {
	...
	return (
		...
		<div id='features' className="flex flex-col items-center my-10 scroll-mt-12">
			...
			<Title
				title="Hear It Straight from Our Users"
				description="Discover what people are saying about us. We’re committed to improving every day — share your experience and help us grow!"
			/>
		</div>
