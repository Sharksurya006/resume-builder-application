...
const Features = () => {
	...
	return (
		<div id='features' className="flex flex-col items-center my-10 scroll-mt-12">
            ...
            <Title title='Build your resume' description='Make a standout resume in no time with the help of our intelligent AI assistant.'/>
					...
					<div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
						<div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-slate-600 max-w-xs">Let our AI instantly enhance your professional summary and job descriptions to be ATS-friendly and compelling.</p>
							</div>
						</div>
					</div>
					<div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
						<div className="p-6 group-hover:bg-indigo-100 border border-transparent group-hover:border-indigo-300 flex gap-4 rounded-xl transition-colors">
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-slate-600 max-w-xs">Choose from Classic, Modern, and Minimal designs — then personalize with your own accent color in seconds.</p>
							</div>
						</div>
					</div>
					<div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
						<div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-slate-600 max-w-xs">Download your resume as a PDF or share a public link directly with recruiters — no sign-in required for viewers.</p>
							</div>
						</div>
					</div>
				</div>
